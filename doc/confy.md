...
it was clear that a better solution needed to be made from scratch.  

That's why Confy was created.  

[Confy](https://codeberg.org/heysokam/confy/releases) is a complete make/cmake replacement,  
...
> Sidenote:  
> Building this project is a single call to `confy build`.  
...
> _You may be surprised. It was made for this engine and this project after all._  
